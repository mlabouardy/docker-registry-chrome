...
@WebAppConfiguration
public class DockerRegistryV1ServiceTest {
	...
	public void getRepositories() throws JsonProcessingException, Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/v1/repositories")
	...
	public void getTags() throws JsonProcessingException, Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/v1/repositories/tags")
				.contentType("application/json")
